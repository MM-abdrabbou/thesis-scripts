...
# This program calls variants in BAM files generated by bwa mem and sorted and indexed by samtools using gatk
...
PATH_REF_FILE=/media/rna/INIA/benchmark/Variant_calling/gatk/bowtie2/Reference_Bowtie2/DM_1-3_516_R44_potato_genome_assembly.v6.1.fa
PATH_VCF_OUT=/media/rna/INIA/benchmark/Variant_calling/gatk/bowtie2/VCF_output
mkdir -p $PATH_VCF_OUT
PATH_STAT_OUT=/media/rna/INIA/benchmark/Variant_calling/gatk/bowtie2/stat
...
#script /media/rna/INIA/benchmark/Variant_calling/gatk/bowtie2/script.txt 
...
for folder in ${PATH_IN_BAMS}/*; do
    ...
    gatk_start=`date +%s`
    # gatk needs a fasta dictionary for reference
...
# gatk needs a fasta dictionary for reference
#./gatk CreateSequenceDictionary -R DM_1-3_516_R44_potato_genome_assembly.v6.1.fa
#samtools faidx DM_1-3_516_R44_potato_genome_assembly.v6.1.fa


#Also gatk needs a certain bam file input
#validate and check for the read groups
#./gatk ValidateSamFile   I=Sample_P1-A03-017-BR_sorted.bam -R DM_1-3_516_R44_potato_genome_assembly.v6.1.fa MODE= SUMMARY
#fix the readgroup issue
#./gatk AddOrReplaceReadGroups -I Sample_P1-A03-017-BR_sorted.bam -O Sample_with_readgroup.bam -SORT_ORDER coordinate -RGID foo -RGLB bar -RGPL illumina -RGPU barcode  -RGSM Sample1 -CREATE_INDEX True



#variant calling
#./gatk HaplotypeCaller -R DM_1-3_516_R44_potato_genome_assembly.v6.1.fa -I Sample_with_readgroup.bam -O raw_variants.vcf
