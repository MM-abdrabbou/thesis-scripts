...
REF_GENOME=/media/rna/INIA/benchmark/Alignment/BWA/Reference_BWA/DM_1-3_516_R44_potato_genome_assembly.v6.1.fa
...
OUT_PATH_BAM=/media/rna/INIA/benchmark/Alignment/BWA/BWA_BAM
mkdir -p $OUT_PATH_BAM
# Creating and specifying the directory for the alignment statistics
OUT_PATH_STAT=/media/rna/INIA/benchmark/Alignment/BWA/BWA_STAT
